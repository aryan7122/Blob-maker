...
function createBlob(){
    ...
    document.getElementById('si1').innerHTML = `${radiusOne}%`
    document.getElementById('si2').innerHTML = `${radiusTwo}%`
    document.getElementById('si3').innerHTML = `${radiusThree}%`
    document.getElementById('si4').innerHTML = `${radiusFour}%`
}
